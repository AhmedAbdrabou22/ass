...
function Blogs() {
  ...
  return (
    ...
    <div className='w-75 mx-auto text-center mt-5'>
        <h2 style={{ textAlign: "center" }} className='infoAbout'>Our Blogs</h2>
        <p style={{ color: "#585858", marginTop: "10px" }}>Explore our Recent blogs to enrichen your information and keep up with new events</p>
