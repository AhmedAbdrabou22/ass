...
const AboutParteners = () => {
    return (
        <div>
            <h2 id="partener">Meet our Partners</h2>
            <div className='d-flex justify-lg-content-between justify-content-center w-100 mt-5 align-items-center my-5 flex-wrap'>
